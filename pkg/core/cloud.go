...
import (
	...
	kubeutils "github.com/caoyingjunz/gopixiu/pkg/util/kubeconfig"
...
func (c *cloud) Load(stopCh chan struct{}) error {
	...
	for _, cloudObj := range cloudObjs {
		...
		kubeConfig, err := kubeutils.ParseKubeConfigData(context.TODO(), c.factory, intstr.FromInt64(cloudObj.Id))
		if err != nil {
