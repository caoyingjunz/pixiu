...
type Interface interface {
	...
	List(ctx context.Context, req *types.ListAIAccountRequest) (interface{}, error)
}
...
func (c *controller) Create(ctx context.Context, req *types.CreateAIAccountRequest) error {
	...
	if err != nil {
		klog.Errorf("failed to create ai account for user(%d): %v", userId, err)
...
func (c *controller) List(ctx context.Context, req *types.ListAIAccountRequest) (interface{}, error) {
	userId, err := httputils.GetUserIdFromContext(ctx)
	if err != nil {
		return nil, apierrors.ErrUnauthorized
	}
