...
```text
GET  /pixiu/auth/oauth/providers
GET  /pixiu/auth/oauth/providers/:provider/config
PUT  /pixiu/auth/oauth/providers/:provider/config
GET  /pixiu/auth/oauth/providers/:provider/login-url
POST /pixiu/auth/oauth/providers/:provider/login
```
