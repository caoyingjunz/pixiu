...
func (s *cloudRouter) initRoutes(ginEngine *gin.Engine) {
	...
	cloudRoute := ginEngine.Group("/clouds")
	{
		...
		//Ingress API
		cloudRoute.GET("/Networkin/v1/:cloud_name/namespaces/:namespace/ingress", s.listIngress)
		cloudRoute.POST("/Networkin/v1/:cloud_name/namespaces/:namespace/ingress/:object_name", s.createIngress)
		cloudRoute.GET("/Networkin/v1/:cloud_name/namespaces/:namespace/ingress/:object_name", s.getIngress)
		cloudRoute.DELETE("/Networkin/v1/:cloud_name/namespaces/:namespace/ingress/:object_name", s.deleteIngress)
	}
}
