...
func (u *userRouter) listOAuthProviders(c *gin.Context) {
	...
	var err error
	if r.Result, err = u.c.User().ListOAuthProviders(c, enabledOnly); err != nil {
		httputils.SetFailed(c, r, err)
		return
	}
	httputils.SetSuccess(c, r)
...
func (u *userRouter) getOAuthProviderConfig(c *gin.Context) {
	r := httputils.NewResponse()

	var err error
	if r.Result, err = u.c.User().GetOAuthProviderConfig(c, c.Param("provider")); err != nil {
		httputils.SetFailed(c, r, err)
		return
	}
	httputils.SetSuccess(c, r)
...
func (u *userRouter) updateOAuthProviderConfig(c *gin.Context) {
	r := httputils.NewResponse()
	...
	if r.Result, err = u.c.User().UpdateOAuthProviderConfig(c, c.Param("provider"), &req); err != nil {
		httputils.SetFailed(c, r, err)
		return
	}
	httputils.SetSuccess(c, r)
...
func (u *userRouter) getOAuthProviderLoginURL(c *gin.Context) {
	r := httputils.NewResponse()

	var err error
	if r.Result, err = u.c.User().GetOAuthProviderLoginURL(c, c.Param("provider")); err != nil {
		httputils.SetFailed(c, r, err)
		return
	}
	httputils.SetSuccess(c, r)
...
func (u *userRouter) loginWithOAuthProvider(c *gin.Context) {
	r := httputils.NewResponse()
